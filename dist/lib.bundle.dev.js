...
;
var GlobalLiteralWatcher = /** @class */ (function () {
    function GlobalLiteralWatcher() {
    ...
    Object.defineProperty(GlobalLiteralWatcher.prototype, "valueChangeSubject", {
        get: function () {
    ...
    GlobalLiteralWatcher.prototype.dispatchChangeWindowsMessage = function (type, data) {
        if (this.isBrowser) {
            var event_1 = new CustomEvent(type, { detail: data });
    ...
    GlobalLiteralWatcher.prototype.stopWatch = function () {
        this.isStop = true;
    };
    GlobalLiteralWatcher.prototype.watch = function () {
        var _this = this;
        if (this.isStop) {
            throw Error('already watch running');
            return false;
        }
        var localCopyForVars = {};
        var originToWatch = Object.keys(window).filter(function (item) {
            try {
        ...
        for (var _i = 0, originToWatch_1 = originToWatch; _i < originToWatch_1.length; _i++) {
            var originToitems = originToWatch_1[_i];
            localCopyForVars[originToitems] = window[originToitems];
        }
        var timeout = 600;
        this.isStop = false;
        if (this.isBrowser) {
            var pollForChange_1 = function () {
                var varsToWatch = Object.keys(window).filter(function (item) {
                    try {
                        return typeof window[item] === 'string' || typeof window[item] === 'number' ? true : false;
                    }
                    catch (e) {
                ...
                for (var _i = 0, varsToWatch_1 = varsToWatch; _i < varsToWatch_1.length; _i++) {
                    var varToWatch = varsToWatch_1[_i];
                    if (localCopyForVars[varToWatch] !== window[varToWatch]) {
                        ...
                        _this.dispatchChangeWindowsMessage('onGlobalVarChange', eventData);
                        _this.valueChangeSubject.next(eventData);
                        localCopyForVars[varToWatch] = window[varToWatch];
                    }
                }
                if (!_this.isStop) {
                    setTimeout(pollForChange_1, timeout);
                }
            };
            if (!this.isStop) {
                setTimeout(pollForChange_1, timeout);
...
var ObjectWatcher = /** @class */ (function () {
    function ObjectWatcher(object, name, parent) {
        ...
        if (object instanceof Array) {
            this.orderSubject = new rxjs_1.Subject();
            var originSort_1 = this.proxyObject['sort'];
            Object.defineProperty(this.proxyObject, 'sort', {
                enumerable: true,
                configurable: true,
                writable: true,
                value: function (compareFn) {
                    var tempOrigin = this.slice();
                    var newObject = originSort_1.call(this, compareFn);
    ...
    Object.defineProperty(ObjectWatcher.prototype, "valueChangeSubject", {
        get: function () {
            return this.valueSubject;
        },
        enumerable: true,
    ...
    Object.defineProperty(ObjectWatcher.prototype, "propChangeSubject", {
        get: function () {
    ...
    Object.defineProperty(ObjectWatcher.prototype, "orderChangerSubject", {
        get: function () {
    ...
    ObjectWatcher.prototype.dispatchChangeWindowsMessage = function (type, data) {
        if (this.isBrowser) {
            var event_2 = new CustomEvent(type, { detail: data });
    ...
    ObjectWatcher.prototype.checkOrderChanged = function (origin, target) {
        var changeIndexArray = new Array();
        var isChanged = false;
...
exports.ObjectWatcher = ObjectWatcher;


/***/ })

/******/ })));
//# sourceMappingURL=lib.bundle.dev.js.map